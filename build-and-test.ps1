...
$windowsImageBuilder = 'microsoft/dotnet-buildtools-prereqs:image-builder-nanoserver-20181211132441'
$linuxImageBuilder = 'microsoft/dotnet-buildtools-prereqs:image-builder-debian-20181211212452'
